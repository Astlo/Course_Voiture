...
void Car::reset()
{
	point_.getX() = Constants::X_BASE_TRAJECTOIRE;
	point_.getY() = Constants::Y_BASE_TRAJECTOIRE;
//	oldPoint_.getX() = point_.getX();
//	oldPoint_.getY() = point_.getY();
	vitesse_ = 0.0;
	angle_ = 0.0;
//	place_ = 0;
//	secteur_ = 1;
...
/*
//------------------------------------------------------------------------------
void Car::setOldPoint(double oldPoint)
{
	oldPoint_ = oldPoint;
}
*/
